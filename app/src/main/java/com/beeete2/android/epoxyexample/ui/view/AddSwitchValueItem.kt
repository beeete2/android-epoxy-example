...
import com.beeete2.android.epoxyexample.ui.switcher.SwitcherFragment

@ModelView(autoLayout = ModelView.Size.MATCH_WIDTH_WRAP_HEIGHT)
class AddSwitchValueItem @JvmOverloads constructor(
    context: Context,
    ...
    @set:ModelProp
    var checked: SwitcherFragment.SwitchValue? = null
    ...
    fun postBindSetup() {
        _label.text = label
        _switch.isChecked = checked?.checked ?: false
